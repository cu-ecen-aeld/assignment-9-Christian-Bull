...
# startup script for ldd modules
...
# faulty module
#
# https://github.com/cu-ecen-aeld/ldd3/blob/master/misc-modules/module_load
#
##############################################################
...
# modprobe to load the hello module
